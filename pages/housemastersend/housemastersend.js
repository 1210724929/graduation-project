...
Page({
  ...
  onLoad: function (options) {
    //console.log(options)
    this.setData({
      housemasterSendType: options.housemasterSendType
    })
  },
